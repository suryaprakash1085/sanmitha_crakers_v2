        ...
        <section className="relative min-h-[88vh] overflow-hidden">
          <div className="container-festive relative z-10 grid lg:grid-cols-2 gap-8 items-center pt-8 pb-20">
            ...
            >
              ...
              <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold leading-[1.1] mb-5 break-words text-foreground">
                {h.hero.title}
                <br />
          ...
          <div className="container-festive">
            ...
            >
              {products.slice(0, 8).map((p, i) => (
                <div
                  key={p.id}
                  className="min-w-[260px] sm:min-w-[270px] snap-start"
                >
                ...
                >
                  ...
                  >
                    <Icon
                      name={w.icon}
                      className="w-7 h-7"
                      style={{ color: `hsl(${w.colorHue} 80% 45%)` }}
                    />
                  </div>
